...
<body class="bg-[#E4E9F7]">
    <div class="flex min-h-screen">
        ...
        <!-- Main Content -->
        <main class="flex-1 p-4 sm:p-6 lg:p-8 lg:ml-[240px] mt-12 sm:mt-14 lg:mt-10 flex items-center justify-center flex-col md:block">
            <!-- Header -->
                    ...
                    <div class="p-4 sm:p-6 space-y-5 sm:space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select
                                    class="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-50 border border-gray-200 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700 text-sm sm:text-base">
                                    <option>Select or Type Position . . .</option>
                        ...
                        <div class="flex justify-end pt-2">
                            <a href="https://character.ai/chat/WjJQ263B_9rZul5wZxBFUoJYXzPki94_qCNhDVh-_-o"
                                target="_blank"
                                class="w-full sm:w-auto px-6 py-2.5 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg transition-colors shadow-sm inline-block text-center text-sm sm:text-base">
                                Begin the Interview
                            </a>
                        </div>
