  ...
  <style>
    ...
    @media (max-width: 768px) {
      .main-card {
        min-height: 100vh;
        border-radius: 0;
        /* opsional, biar fullscreen tanpa sudut bulat */
      }
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  <!-- Card Container -->
  <div
    class="main-card bg-white w-full max-w-6xl rounded-3xl shadow-2xl p-5 flex flex-col lg:h-[90vh] justify-between overflow-hidden">
    <!-- Header -->
    <div
      class="flex justify-between items-center w-full mb-6 sm:mb-6 md:px-6">
    ...
    <div class="content-container flex flex-col md:flex-row flex-1 w-full gap-6 sm:gap-10">
      ...
      <div class="form-container w-full md:w-1/2 flex flex-col justify-center px-4 sm:px-12">
        <h2 class="font-bold leading-tight mb-3 text-3xl md:text-5xl">
          Forgot <br />
