...
<body class="h-screen bg-[#E4E9F7] transition-all">
   ...
   <?php echo $current_page == 'scriptbuilder.php' ? 'bg-gray-100 text-gray-900' : 'text-gray-700 hover:bg-gray-100'; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7. manufacturer-3-4.5 16.5" />
                </svg>
   ...
   <?php echo $current_page == 'setting.php' ? 'bg-gray-100 text-gray-900' : 'text-gray-700 hover:bg-gray-100'; ?>">
        ...
        <div class="flex items-center justify-between w-50 p-6 border gap-2">
            <div class="flex items-center space-x-3">
                <img src="<?php echo htmlspecialchars($base_url . $avatar); ?>" alt="Foto Profil" class="w-11 h-11 rounded-full bg-gray-200 object-cover">
                <div>
                    <p class="text-[15px] font-semibold text-gray-900"><?php echo htmlspecialchars($username); ?></p>
                    <p class="text-[10px] text-gray-600"><?php echo htmlspecialchars($email); ?></p>
                </div>
            </div>
